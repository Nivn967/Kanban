...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    {
        public BusinessLayer.UserController uc;
        ...
        public GradingService()
        {
            ...
            uc = userService.userController;
            boardController = boardService._bc;
        }
        ...
        {
            return boardService.LimitColumn(email, boardName, limit, columnOrdinal);
        }
        ...
        {
            return taskService.AddTask(email, boardName, 0, dueDate, title, description);
        }
        ...
        {
            return taskService.EditTaskDueDate(email, boardName, dueDate, taskId, columnOrdinal);
        }
        ...
        {
            return taskService.EditTaskTitle(email, boardName, title, taskId, columnOrdinal);
        }
        ...
        {
            return taskService.EditTaskDescription(email, boardName, description, taskId, columnOrdinal);
        }
        ...
        {
            return taskService.AdvanceTask(boardName, taskId, columnOrdinal, email);
        }
        ...
        {
            return boardService.getAssigneeInProgressTasks(email);
        }
